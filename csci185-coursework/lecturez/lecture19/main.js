...
function displayResults(data) {
    ...
    for (let i = 0; i < data.length; i++){
        const course = data[i];
        console.log([i]);
        //sometimes coused don't yet have 
        //instructors assigned, so we need to check
        //before we try abd access the first instrutor
...
let instructor ='TBD';
    ...
    // console.log(data);
    // console.log(data[0].Department, data[0].Instructors[0]);
